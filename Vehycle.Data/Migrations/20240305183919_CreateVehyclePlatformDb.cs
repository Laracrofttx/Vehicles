...
{
    /// <inheritdoc />
    public partial class CreateVehyclePlatformDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EuStandart = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    VehycleType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    VehycleInfo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vehycles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Vehycles_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehycleId = table.Column<int>(type: "int", nullable: false),
                    VehycleId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationUserForumPost",
                columns: table => new
                {
                    ForumPostsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UsersId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserForumPost", x => new { x.ForumPostsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserForumPost_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserForumPost_ForumPosts_ForumPostsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehycleAds", x => new { x.VehycleId, x.AdId });
                    table.ForeignKey(
                        name: "FK_VehycleAds_Ads_AdId",
                        column: x => x.AdId,
                        principalTable: "Ads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VehycleAds_Vehycles_VehycleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ads_PostedById",
                table: "Ads",
                column: "PostedById");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserForumPost_UsersId",
                table: "ApplicationUserForumPost",
                column: "UsersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehycleAds_AdId",
                table: "VehycleAds",
                column: "AdId");

            migrationBuilder.CreateIndex(
                name: "IX_Vehycles_CategoryId",
                table: "Vehycles",
                column: "CategoryId");
        }
